...
import jp.mixi.practice.sqlite.BookOpenHelper;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BookOpenHelper bookOpenHelper = new BookOpenHelper(getApplicationContext());
    ...
    private void insert(BookOpenHelper bookOpenHelper) {
        ...
        Log.e("insert", Long.toString(rowId));
    }
    ...
    private void delete(BookOpenHelper bookOpenHelper) {
        ...
        Toast.makeText(getApplicationContext(), Integer.toString(deletedCount), Toast.LENGTH_SHORT).show();
        Log.e("delete", Integer.toString(deletedCount));
    }
    ...
    private void update(BookOpenHelper bookOpenHelper) {
        ...
        // update情報を設定する
        ContentValues values = new ContentValues();
        values.put(Book.COLUMN_NAME_BOOK_TITLE, "NEW_TITLEげえええええええ！？");
        ...
        Toast.makeText(getApplicationContext(), Integer.toString(updatedCount), Toast.LENGTH_SHORT).show();
        Log.e("update", Integer.toString(updatedCount));
    ...
    private void query(BookOpenHelper bookOpenHelper) {
        ...
        Toast.makeText(getApplicationContext(), Long.toString(itemId), Toast.LENGTH_SHORT).show();
        Log.e("select", Long.toString(itemId));        
    }
