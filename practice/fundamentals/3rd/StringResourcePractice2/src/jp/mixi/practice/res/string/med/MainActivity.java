...
public class MainActivity extends Activity implements TextWatcher {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        count = count + start;
        countView.setText(getString(R.string.text_counter, count, TEXT_MAX_LENGTH));
    }
    ...
    public void onConfirmClick(View v) {
        ...
        Toast.makeText(this, getString(R.string.toast_message, name, mClickCount), Toast.LENGTH_SHORT).show();
    }
}